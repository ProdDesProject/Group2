...
public class LogTests {
    ...
    public void equalsShouldReturnTrueOnValid() {
        Log validLogCopy = new Log(validLog0.getId(), validLog0.getDate(), validLog0.getHeartRate(),
    ...
    public void equalsShouldReturnFalseOnInValid() {
        Log invalidLogCopy = new Log(validLog0.getId(), validLog0.getDate(), validLog0.getHeartRate(),
                validLog0.getUserId(), validLog0.getSleepSession());
